...
* this do-file produces the overview plots that I showed in class. It's COMPLETELY optional, and you can skip it entirely. The only reason you might want to look at this, is if you need help writing code, or steal some ideas for your project on how to create graphs, or if you just want to revisit the explanations from class.
clear all
...
legend(order(1 2) label(1 "High education") label(2 "Low education")) ///
ytitle("Wage (in $)") ///
title("wages{subscript:i} = {&alpha} + {&beta}{subscript:1}*Hours{subscript:i} + {&beta}{subscript:2}*Educ{subscript:i} + {&epsilon}{subscript:i}", size(medium))
...
legend(order(1 2) label(1 "High education") label(2 "Low education")) ///
ytitle("Wage (in $)") xtitle("Hours spent on YouTube") ///
title("wages{subscript:i} = {&alpha} + {&beta}{subscript:1}*Hours{subscript:1{subscript:i}} + {&beta}{subscript:2}*Educ{subscript:i} + {&epsilon}{subscript:i}", size(medium))
...
gen Educ = 1 in 1/500 
replace Educ = 0 if Educ == .
gen wages = 100+ 2*hours + Educ*100 + 3*Educ*hours + rnormal(0,10)
label define Educ 1 "High education" 0 "Low education"
label values Educ Educ
lab var wages "Wage (in $)"
lab var hours "Hours spent on YouTube"
...
legend(order(1 2) label(1 "High education") label(2 "Low education")) ///
ytitle("Wage (in $)") ///
title("wages{subscript:i} = {&alpha} + {&beta}{subscript:1}*Hours{subscript:i} + {&beta}{subscript:2}*Educ{subscript:i} + {&beta}{subscript:3}*Educ{subscript:i}*Hours{subscript:i} + {&epsilon}{subscript:i}", size(medsmall))
...
legend(order(1 2) label(1 "High education") label(2 "Low education")) ///
ytitle("Wage (in $)") ///
title("High educ: wages{subscript:i} = {&alpha}{subscript:1} + {&beta}{subscript:1}*Hours{subscript:i} + {&beta}{subscript:2}*1 + {&beta}{subscript:3}*1*Hours{subscript:i} + {&epsilon}{subscript:i}" ///
"Low educ: wages{subscript:i} = {&alpha}{subscript:2} + {&beta}{subscript:4}*Hours{subscript:i} + {&beta}{subscript:5}*0 + {&beta}{subscript:6}*0*Hours{subscript:i} + {&nu}{subscript:i}", size(small))
...
"Only for high education sample: wages{subscript:i} = {&alpha}{subscript:1} + {&beta}{subscript:1}*Hours{subscript:i} + {&epsilon}{subscript:i}" ///
"Only for low education sample: wages{subscript:i} = {&alpha}{subscript:2} + {&beta}{subscript:4}*Hours{subscript:i} + {&nu}{subscript:i}", size(small))
